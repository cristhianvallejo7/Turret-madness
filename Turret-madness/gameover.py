...
gameover =p.image.load("images\\gameover.png")
...
def main_menu():
    ...
    while running:
        if boton_1 == None and boton_2 == None:
            ...
            pantalla.blit(gameover,(300,30))
            draw_txt("GAME", font_2, (0, 0, 0), pantalla, 25, 18)
            draw_txt("GAME", font_2, (255, 255, 255), pantalla, 20, 10)
            draw_txt("OVER", font_1, (0, 0, 0), pantalla, 25, 86)
            draw_txt("OVER", font_1, (255, 255, 255), pantalla, 20, 78)
        else:
        ...
        draw_txt("Reiniciar", font, (0, 0, 0), pantalla, 37, 208)
        draw_txt("Reiniciar", font, (255, 255, 255), pantalla, 35, 205)
        ...
        if boton_1.collidepoint((mx, my)):
            ...
            draw_txt("Reiniciar", font, (0, 0, 0), pantalla, 37, 200)
            draw_txt("Reiniciar", font, (255, 255, 255), pantalla, 35, 197)
            canal1.play(tap)
            if click:
                canal2.play(select)
                reiniciar()
